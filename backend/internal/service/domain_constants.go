...
const (
	AffiliateRebateRateDefault          = 15.0
...
const (
	...
	RedeemTypeSignupBonus      = domain.RedeemTypeSignupBonus
...
const (
	...
	// SettingKeyRewriteMessageCacheControl 是否改写 messages[*].content[*].cache_control（默认 true）
