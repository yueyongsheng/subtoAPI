...
func TestNewConfiguredCodexModelDescriptorUsesProviderMetadataAndSafeFallback(t *testing.T) {
	...
	require.Equal(t, "GPT-6 Sol", gpt6Sol.DisplayName)
	...
	require.True(t, isOpenAICodexImageInputModel("gpt-6-sol"))
	require.True(t, isOpenAICodexReasoningGPTModel("gpt-6-sol"))
	require.Equal(t, int64(1_050_000), gpt6Sol.ContextWindow)
	require.Equal(t, int64(1_050_000), gpt6Sol.MaxContextWindow)
	gpt6 := newConfiguredCodexModelDescriptor("gpt-6")
	require.NotEqual(t, "GPT-6 (Astra)", gpt6.DisplayName)
	require.NotEqual(t, int64(1_050_000), gpt6.ContextWindow)
