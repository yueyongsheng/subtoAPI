...
const gpt55OverrideCatalogJSON = `{
	...
	"gpt-5.4": {"litellm_provider": "openai", "mode": "chat",
		...
		"output_cost_per_token_above_272k_tokens": 78.75e-06}
}`
...
func TestPricingOverride_ExplicitZeroThresholdDisablesCatalogLadder(t *testing.T) {
	...
	require.InDelta(t, 1000*105e-6, cost.OutputCost, 1e-10)
	require.InDelta(t, 10000*1.75e-6, cost.CacheReadCost, 1e-10)
}
...
func TestPricingOverride_FieldLevelMergeKeepsOtherFields(t *testing.T) {
	...
	require.InDelta(t, 17.5e-6/3e-6, patched.LongContextInputCostMultiplier, 1e-9)
}
