...
func TestAstraCatalogPreservesFixedReasoningContract(t *testing.T) {
	...
	require.NotContains(t, model, "multi_agent_reasoning_effort")
	require.NotContains(t, model, "multi_agent_version")
...
func TestAstraCatalogIgnoresExplicitWorkflowOverrides(t *testing.T) {
