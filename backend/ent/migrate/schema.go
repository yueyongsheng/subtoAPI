		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorsColumns[16], ChannelMonitorsColumns[19]},
			},
			{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{ChannelMonitorHistoriesColumns[15]},
				RefColumns: []*schema.Column{ChannelMonitorsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorHistoriesColumns[15], ChannelMonitorHistoriesColumns[1], ChannelMonitorHistoriesColumns[14]},
			},
			{
				Name:    "channelmonitorhistory_monitor_id_model_source_bucket_start",
				Unique:  true,
				Columns: []*schema.Column{ChannelMonitorHistoriesColumns[15], ChannelMonitorHistoriesColumns[1], ChannelMonitorHistoriesColumns[3], ChannelMonitorHistoriesColumns[4]},
			},
			{
