export default {
    ...
    users: {
      overview: {
        ...
        todaySpend: '今日用户总消费',
        todaySpendCny: '折合人民币',
        spendConversion: '（消费 ÷ 25）',
        todaySpendHint: '按 UTC+8 今日已扣除金额统计',
        ranking: {
          all: '全部',
          spendingTitle: '今日消费前 10 名',
          concurrencyTitle: '当前并发前 10 名',
          count: '{count} 人',
          user: '排名 / 用户',
          spendingColumn: '今日消费',
          concurrencyColumn: '当前并发',
          spendingHint: 'UTC+8 今日实际扣费 · RMB = USD ÷ 25 · 最多 10 人',
          concurrencyHint: '查询时正在处理的请求 · 仅展示并发大于 0 的用户 · 最多 10 人',
          noSpending: '今日暂无消费用户',
          noConcurrency: '当前无并发请求',
          failed: '排名查询失败，请点击刷新重试；已显示的数据为上次成功查询结果。',
        },
        cny: '折合人民币',
        conversion: '（余额 ÷ 25）',
        positiveUsers: '仅统计 {count} 位正余额用户，欠费余额不计入',
        concurrency: '用户当前总并发数',
        maxConcurrency: '当前单用户最高并发',
        maxConcurrencyHint: '当前所有用户中并发最高的一位',
        maxConcurrencyUser: '用户：{name}',
        maxConcurrencyTied: '等 {count} 位用户并列最高',
        noConcurrentUsers: '当前无并发请求',
        maxConcurrencyUserUnavailable: '用户信息暂不可用，请稍后刷新',
        unnamedUser: '未设置用户名',
        requests: '个',
