export default {
  ...
  modelPlaza: {
    ...
    table: {
      ...
      timePricingRowHintPeak: '；本行价格未含高峰倍率，与高峰时段 {window} 重叠的部分实付再乘 x{multiplier}',
      timePricingWeekdays: '工作日',
      timePricingRateHint: '生效倍率 {rate} x 时段倍率 {multiplier}',
      paidPrice: '实付价格(折后)',
      officialPrice: '官方价格',
      rate: '折扣倍率',
  ...
  affiliate: {
    ...
    transfer: {
      title: '返利额度转余额',
      description: '返利额度仅可转入账户余额，不支持现金提现',
      button: '转入余额',
      transferring: '转入中...',
      empty: '当前没有可转入额度',
    ...
    tips: {
      ...
      line3: '返利额度可随时转入账户余额。',
      line4: '新产生的返利经过冻结期后可转入账户余额，不支持现金提现。'
    }
  },
