export default {
  ...
  usage: {
    ...
    actualCost: 'Actual',
    accountCost: 'Cost',
    userBilled: 'User balance charged',
    accountBilled: 'Estimated upstream cost',
    resetNow: 'Now',
    ...
    cacheHitRateHint: 'Cache read ÷ (uncached input + cache creation + cache read) × 100%. Output tokens are excluded.',
  ...
  modelPlaza: {
    ...
    table: {
      ...
      timePricingRowHintPeak:
        '; prices in this row exclude the peak-hour rate; where this period overlaps the peak hours {window}, the overlapping portion is additionally multiplied by x{multiplier}',
      timePricingWeekdays: 'Weekdays',
      timePricingRateHint: 'Effective rate {rate} x period multiplier {multiplier}',
  ...
  redeem: {
	...
	balanceAddedSignup: 'Registration Bonus',
