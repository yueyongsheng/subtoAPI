export default {
    ...
    users: {
      overview: {
        ...
        todaySpend: 'Today user spending',
        todaySpendCny: 'CNY equivalent',
        spendConversion: '(spending ÷ 25)',
        todaySpendHint: 'Charged amount for today in UTC+8',
        ranking: {
          all: 'All',
          spendingTitle: "Today's top 10 spenders",
          concurrencyTitle: 'Top 10 by current concurrency',
          count: '{count} users',
          user: 'Rank / User',
          spendingColumn: "Today's spending",
          concurrencyColumn: 'Current concurrency',
          spendingHint: 'Actual charges today (UTC+8) · RMB = USD ÷ 25 · Up to 10 users',
          concurrencyHint: 'Requests in progress at query time · Positive concurrency only · Up to 10 users',
          noSpending: 'No spending today',
          noConcurrency: 'No active requests',
          failed: 'Could not load rankings. Refresh to retry; any displayed data is from the last successful query.',
        },
        cny: 'CNY equivalent',
        ...
        maxConcurrency: 'Current highest user concurrency',
        maxConcurrencyHint: 'Highest active request count for one user',
        maxConcurrencyUser: 'User: {name}',
        maxConcurrencyTied: 'Among {count} users tied for highest',
        noConcurrentUsers: 'No active requests',
        maxConcurrencyUserUnavailable: 'User information unavailable. Please refresh later.',
