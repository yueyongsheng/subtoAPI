export default {
  plugins: {
    ...
    uiLoadTimeout: 'The configuration UI timed out. Please retry. The plugin continues running in the background.',
    retryUI: 'Reload configuration',
    ...
    confirmDisable: 'Disable this plugin? New OAuth requests return to the built-in Sub2API path. In-flight requests get up to 10 seconds before the plugin process and its background tasks stop. Configuration is retained.',
