export default {
  ...
  support: {
    ...
    wechatGroupTitle: 'Join the Yuexiang API WeChat Group',
    wechatGroupHint: 'Scan with WeChat to join the discussion group and receive service updates.',
    wechatGroupQrAlt: 'Yuexiang API WeChat discussion group QR code',
